    ...
    <header className="sticky top-0 z-40 border-b border-slate-200/80 bg-white/90 backdrop-blur-xl" dir="rtl">
      <div className="mx-auto flex max-w-7xl items-center gap-4 px-4 py-3 sm:px-6 lg:px-8">
        <Link href="/dashboard" className="flex min-w-0 items-center gap-3">
          ...
          <span className="hidden min-w-0 sm:block">
            ...
            <span className="block truncate text-[11px] font-semibold text-slate-500">
              Scholarly intelligence workspace
            </span>
          </span>
        </Link>
        ...
        <div className="flex shrink-0 items-center gap-2">
          <Link
            href="/search"
            className="hidden rounded-xl bg-slate-950 px-4 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-slate-800 lg:inline-flex"
          >
            بحث جديد
          </Link>
          <SignedOut>
